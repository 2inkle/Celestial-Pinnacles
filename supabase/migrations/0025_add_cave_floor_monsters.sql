...
set
  data = data || $monsters$[
    ...
    {"id":"cave_stalactite_crusher","name":"종유석파괴자","portrait":"🗿","realStats":{"str":18,"int":8,"dex":8,"spd":9,"luk":8},"combatReal":{"atk":20,"def":65,"mdef":65},"maxHp":26000,"tier":"elite","passiveMods":{"accuracyBonusPct":-70},"patterns":[{"subject":"self","metric":"battleTurn","comparator":"gte","value":1,"action":"굳은 돌가죽","maxUses":2},{"subject":"self","metric":"always","action":"무너지는 종유석"}],"expReward":45,"goldReward":19,"dropTable":[{"name":"철광석","category":"material","chance":0.4,"quantity":[1,2]},{"name":"정동석","category":"material","chance":0.15,"quantity":[1,1]},{"name":"무너지는 천장의 파편","category":"keyItem","chance":0.15,"quantity":[1,1]}]},
    {"id":"cave_troll","name":"동굴트롤","portrait":"🧌","realStats":{"str":20,"int":8,"dex":8,"spd":12,"luk":8},"combatReal":{"atk":30,"def":78,"mdef":78},"maxHp":16500,"tier":"normal","patterns":[{"subject":"self","metric":"always","action":"짓밟기"}],"expReward":50,"goldReward":21,"dropTable":[{"name":"철광석","category":"material","chance":0.45,"quantity":[1,2]},{"name":"정동석","category":"material","chance":0.12,"quantity":[1,1]}]},
    {"id":"cave_earth_spirit","name":"대지정령","portrait":"🌋","realStats":{"str":22,"int":8,"dex":8,"spd":10,"luk":8},"combatReal":{"atk":18,"def":68,"mdef":68},"maxHp":19000,"tier":"elite","patterns":[{"subject":"self","metric":"battleTurnMultiple","value":2,"action":"대지의 축복"},{"subject":"self","metric":"always","action":"지진"}],"expReward":55,"goldReward":24,"dropTable":[{"name":"철광석","category":"material","chance":0.5,"quantity":[2,3]},{"name":"정동석","category":"material","chance":0.2,"quantity":[1,2]},{"name":"지진의 전조","category":"keyItem","chance":0.12,"quantity":[1,1]}]},
    {"id":"cave_crystal_golem","name":"수정골렘","portrait":"💎","realStats":{"str":22,"int":8,"dex":8,"spd":13,"luk":8},"combatReal":{"atk":35,"def":75,"mdef":75},"maxHp":19000,"tier":"elite","patterns":[{"subject":"self","metric":"hp","comparator":"lte","value":60,"action":"결정화","maxUses":1},{"subject":"self","metric":"always","action":"수정 낙하"}],"expReward":48,"goldReward":20,"dropTable":[{"name":"철광석","category":"material","chance":0.45,"quantity":[1,3]},{"name":"정동석","category":"material","chance":0.25,"quantity":[1,2]}]}
  ]$monsters$::jsonb,
  version = '2026-08-31a'
