...
// rarity — shop.html의 "판매" 기능이 판매가를 매길 때 쓰는 희귀도 등급
// (2026-08-31 신설). "common"/"uncommon"/"rare"/"epic"/"legendary" 중 하나 —
// 세세한 개별 가격 대신 이 등급으로만 매김(RARITY_SELL_PRICE, shop.html
// 참고). 생략하면 shop.html이 "common"으로 취급.
const MATERIAL_TABLE = {
  "나무": { label: "나무", flavor: "고블린 마을 주변 숲에서 흔히 구할 수 있는 재목.", rarity: "common" },
  "돌": { label: "돌", flavor: "성채 주변에 굴러다니는 잡석. 가공하면 제법 단단하다.", rarity: "common" },
  "광석": { label: "광석", flavor: "고블린들이 캐낸 금속 원석. 무기와 갑옷의 뼈대가 된다.", rarity: "common" },
  // 동굴(1티어) 상위 재료 — "돌"/"광석"보다 한 단계 위, 다음 파밍 단계
  // ("철 기반 아이템 — 무겁지만 성능 우수")로 이어지는 떡밥(2026-08-31,
  // CLAUDE.md "동굴 저층 실제 데이터 작성" 참고).
  "철광석": { label: "철광석", flavor: "동굴 깊은 곳에서만 나는 무거운 원석. 일반 광석보다 훨씬 단단하다.", rarity: "uncommon" },
  "정동석": { label: "정동석", flavor: "속이 결정으로 가득 찬 희귀한 돌. 무게가 상당해 다루기 까다롭다.", rarity: "rare" },
};
