...
캐릭터에 몰리면 위험해질 수 있다**는 정도의 긴장감만 줌(팀 전체를 쓸어버리는
Enemy-All류와는 다른, 더 절제된 방식의 후열 위협). 이 몹들이 위 "계층별
난이도 곡선"에서 정한 4계층부터의 후열 위협 도입과 정확히 어떻게 맞물리는지
(4계층 전용인지, 일반 구획 전반에 낮은 빈도로 섞이는지)는 다음에 이어갈 것.
